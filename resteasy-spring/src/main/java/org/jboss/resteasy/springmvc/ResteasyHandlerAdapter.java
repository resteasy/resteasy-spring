...
public class ResteasyHandlerAdapter extends
    ...
    protected ModelAndView handle(ResteasyRequestWrapper requestWrapper,
        ...
        if (requestWrapper.getAbortedResponse() != null) {
            ServerResponseWriter.writeNomapResponse(((BuiltResponse) requestWrapper.getAbortedResponse()),
                    requestWrapper.getHttpRequest(), response, dispatcher.getProviderFactory(), t -> {
                    });
            return null;
        }
