...
public class ContextRefreshDependenciesInDeploymentTest {
    ...
    private static Archive<?> deploy() {
        WebArchive archive = ShrinkWrap
                .create(WebArchive.class, ContextRefreshDependenciesInDeploymentTest.class.getSimpleName() + ".war")
                ...
                .addAsWebInfResource(ContextRefreshDependenciesInDeploymentTest.class.getPackage(),
                        "contextRefresh/applicationContext.xml", "applicationContext.xml");
